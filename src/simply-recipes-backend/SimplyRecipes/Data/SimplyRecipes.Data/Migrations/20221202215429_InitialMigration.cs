        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePath = table.Column<string>(maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ingredients = table.Column<string>(maxLength: 20000, nullable: false),
                    Rate = table.Column<int>(nullable: false),
                    PreparationTime = table.Column<double>(nullable: false),
                    CookingTime = table.Column<double>(nullable: false),
                    PortionsNumber = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewComments_ReviewComments_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewComments_IsDeleted",
                table: "ReviewComments",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewComments_ParentId",
                table: "ReviewComments",
                column: "ParentId");
