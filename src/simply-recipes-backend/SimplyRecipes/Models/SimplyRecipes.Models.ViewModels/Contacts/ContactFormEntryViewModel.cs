namespace SimplyRecipes.Models.ViewModels.Contacts
{
    using SimplyRecipes.Common.Attributes;
    using System.ComponentModel.DataAnnotations;

    using static SimplyRecipes.Models.Common.ModelValidation.ContactFormEntryValidation;
